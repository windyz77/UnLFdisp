...
class MonodepthModel(object):
    ...
    def __init__(self, params, mode, images_list, reuse_variables=None, model_index=None):
        ...
        # self.center = self.input_nine
        # self.center = images_list
    ...
    def build_resnet50(self):
        ...
        with tf.variable_scope('disps_'):
            ...
            iconv3 = conv(concat3, 64, 3, 1)  # (96,96,64)
            disp3 = self.get_disp(iconv3)  # (96,96,25)
            ...
            self.disp_14 = tf.expand_dims(self.disp1[:, :, :, 14], 3)  # 14
    ...
    def build_outputs(self):
        ...
        with tf.variable_scope('disparities'):
            ...
            self.mask_1 = tf.squeeze(self.mask, axis=1)
            self.mask_1 = tf.transpose(self.mask_1, [3, 1, 2, 0])
            self.our_mask = tf.concat(self.mask_1, axis=0)
            """
    ...
    def left_right_consistent(self, center_disp):
        pred_disp_center = [center_disp]
        pred_disp_center.append(
            self.generate_image_bottomright(self.disp_1, center_disp * 3, center_disp * 3))
        pred_disp_center.append(
            self.generate_image_bottomright(self.disp_2, center_disp * 2, center_disp * 2))
        pred_disp_center.append(
            self.generate_image_bottomright(self.disp_3, center_disp * 1, center_disp * 1))
        pred_disp_center.append(
            self.generate_image_topleft(self.disp_4, center_disp * 1, center_disp * 1))
        pred_disp_center.append(
            self.generate_image_topleft(self.disp_5, center_disp * 2, center_disp * 2))
        pred_disp_center.append(
            self.generate_image_topleft(self.disp_6, center_disp * 3, center_disp * 3))
        pred_disp_center.append(
            self.generate_image_bottomleft(self.disp_7, center_disp * 3, center_disp * 3))
        pred_disp_center.append(
            self.generate_image_bottomleft(self.disp_8, center_disp * 2, center_disp * 2))
        pred_disp_center.append(
            self.generate_image_bottomleft(self.disp_9, center_disp * 1, center_disp * 1))
        pred_disp_center.append(
            self.generate_image_topright(self.disp_10, center_disp * 1, center_disp * 1))
        pred_disp_center.append(
            self.generate_image_topright(self.disp_11, center_disp * 2, center_disp * 2))
        pred_disp_center.append(
            self.generate_image_topright(self.disp_12, center_disp * 3, center_disp * 3))
        pred_disp_center.append(self.generate_image_right(self.disp_13, center_disp * 3))
        pred_disp_center.append(self.generate_image_right(self.disp_14, center_disp * 2))
        pred_disp_center.append(self.generate_image_right(self.disp_15, center_disp * 1))
        pred_disp_center.append(self.generate_image_left(self.disp_16, center_disp * 1))
        pred_disp_center.append(self.generate_image_left(self.disp_17, center_disp * 2))
        pred_disp_center.append(self.generate_image_left(self.disp_18, center_disp * 3))
        pred_disp_center.append(self.generate_image_bottom(self.disp_19, center_disp * 3))
        pred_disp_center.append(self.generate_image_bottom(self.disp_20, center_disp * 2))
        pred_disp_center.append(self.generate_image_bottom(self.disp_21, center_disp * 1))
        pred_disp_center.append(self.generate_image_top(self.disp_22, center_disp * 1))
        pred_disp_center.append(self.generate_image_top(self.disp_23, center_disp * 2))
        pred_disp_center.append(self.generate_image_top(self.disp_24, center_disp * 3))
        ...
        consistent_loss = tf.zeros_like(mean_disp_center, dtype=tf.float32)
        consistent_loss += self.comput_l2_loss(pred_disp_center[0], self.mean_disp_center)
        consistent_loss += self.comput_l2_loss(pred_disp_center[1], self.mean_disp_center,
                                               self.mask_disp1)
        consistent_loss += self.comput_l2_loss(pred_disp_center[2], self.mean_disp_center,
                                               self.mask_disp2)
        consistent_loss += self.comput_l2_loss(pred_disp_center[3], self.mean_disp_center,
                                               self.mask_disp3)
        consistent_loss += self.comput_l2_loss(pred_disp_center[4], self.mean_disp_center,
                                               self.mask_disp4)
        consistent_loss += self.comput_l2_loss(pred_disp_center[5], self.mean_disp_center,
                                               self.mask_disp5)
        consistent_loss += self.comput_l2_loss(pred_disp_center[6], self.mean_disp_center,
                                               self.mask_disp6)
        consistent_loss += self.comput_l2_loss(pred_disp_center[7], self.mean_disp_center,
                                               self.mask_disp7)
        consistent_loss += self.comput_l2_loss(pred_disp_center[8], self.mean_disp_center,
                                               self.mask_disp8)
        consistent_loss += self.comput_l2_loss(pred_disp_center[9], self.mean_disp_center,
                                               self.mask_disp9)
        consistent_loss += self.comput_l2_loss(pred_disp_center[10], self.mean_disp_center,
                                               self.mask_disp10)
        consistent_loss += self.comput_l2_loss(pred_disp_center[11], self.mean_disp_center,
                                               self.mask_disp11)
        consistent_loss += self.comput_l2_loss(pred_disp_center[12], self.mean_disp_center,
                                               self.mask_disp12)
        consistent_loss += self.comput_l2_loss(pred_disp_center[13], self.mean_disp_center,
                                               self.mask_disp13)
        consistent_loss += self.comput_l2_loss(pred_disp_center[14], self.mean_disp_center,
                                               self.mask_disp14)
        consistent_loss += self.comput_l2_loss(pred_disp_center[15], self.mean_disp_center,
                                               self.mask_disp15)
        consistent_loss += self.comput_l2_loss(pred_disp_center[16], self.mean_disp_center,
                                               self.mask_disp16)
        consistent_loss += self.comput_l2_loss(pred_disp_center[17], self.mean_disp_center,
                                               self.mask_disp17)
        consistent_loss += self.comput_l2_loss(pred_disp_center[18], self.mean_disp_center,
                                               self.mask_disp18)
        consistent_loss += self.comput_l2_loss(pred_disp_center[19], self.mean_disp_center,
                                               self.mask_disp19)
        consistent_loss += self.comput_l2_loss(pred_disp_center[20], self.mean_disp_center,
                                               self.mask_disp20)
        consistent_loss += self.comput_l2_loss(pred_disp_center[21], self.mean_disp_center,
                                               self.mask_disp21)
        consistent_loss += self.comput_l2_loss(pred_disp_center[22], self.mean_disp_center,
                                               self.mask_disp22)
        consistent_loss += self.comput_l2_loss(pred_disp_center[23], self.mean_disp_center,
                                               self.mask_disp23)
        consistent_loss += self.comput_l2_loss(pred_disp_center[24], self.mean_disp_center,
                                               self.mask_disp24)

        return tf.reduce_mean(consistent_loss[:, 10:-10, 10:-10, :])
    ...
    def build_losses(self):
        with tf.variable_scope('losses', reuse=self.reuse_variables):
            ...
            self.refine_loss = self.comput_loss_45degree_center_orientation(self.center, self.center_disp)
            ...
            total_image_loss += image_loss_0 + image_loss_90 + image_loss_45 + image_loss_135
            # disp_consistent_loss = self.left_right_consistent(self.disp_center_est)
            # disp_consistent_loss_1 = self.left_right_consistent(self.center_disp)
            self.new_loss = self.nine_output(self.center)
            self.imageloss = total_image_loss
            # self.total_loss = self.new_loss + self.imageloss + disp_consistent_loss * 0.5 + self.refine_loss
            self.total_loss = self.new_loss + self.imageloss  + self.refine_loss
    ...
    def build_summaries(self):
        ...
        with tf.device('/cpu:0'):
            ...
            # tf.summary.scalar('refine_loss', self.refine_loss, collections=self.model_collection)
            # show disparity
            tf.summary.image('disp_center_est', (self.disp_center_est + 4.) * 32, max_outputs=4,
                             collections=self.model_collection)
            # tf.summary.image('mean_disp_center', (self.mean_disp_center + 4.) * 32, max_outputs=4,
            #                  collections=self.model_collection)
